            ...
            <div className="plc-form-container">
                ...
                <form onSubmit={handleSubmit} className="plc-form">
                    ...
                    <div className="plc-form-section">
                        ...
                        <div className="plc-form-field-full-row">
                            <label className="plc-form-label">Equipment/s to be affected:</label>
                            <input
                                type="text"
                    ...
                    <div className="plc-form-section">
                        <h3 className="plc-form-section-title">DETAILS OF PLC SIGNAL MODIFICATION:</h3>
                        <textarea
                    ...
                    <div className="plc-form-section">
                        <h3 className="plc-form-section-title">REASON FOR SIGNAL MODIFICATION:</h3>
                        <textarea
                    ...
                    <div className="plc-form-field-row">
                        <label className="plc-form-label">Expected Duration of the PLC signal Modification if temporary:</label>
                    ...
                    {true && (
                        <div className="plc-form-section">
                            <table className="plc-form-duration-table">
                                <thead>
                                    <tr>
                                        <th className="plc-form-duration-header-cell">Date and time Applied</th>
                                        <th className="plc-form-duration-header-cell">Date and time Canceled</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                    ...
                    <div className="plc-form-actions no-print">
                        <button type="button" className="plc-form-btn-cancel" onClick={() => navigate('/home')}>
                            Cancel
                        </button>
